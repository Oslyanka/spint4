...
namespace SwaggerSchoolAPI.Controllers
{
    ...
    {
        private readonly IRepository<Matricula> _repo;
        public MatriculasController(IRepository<Matricula> repo) => _repo = repo;
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Update(int id, Matricula m)
        {
